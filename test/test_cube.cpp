...
int main() {
    ...
    renderer.GetCamera().Transform(rend::CreateMoveMatrix(0, 100, 100));
    renderer.GetCamera().Transform(rend::CreateRotationMatrix(2, 3.141592 / 4));

    rend::Matrix4 rm = rend::CreateRotationMatrix(0, 3.141592 / 240);
